    ...
    >
      <div className="container-evermaze flex items-center justify-between py-4">
        ...
        <Link to="/" className="flex flex-col items-center leading-none">
          ...
          <span className="mt-1 text-[0.6rem] md:text-[0.65rem] tracking-[0.4em] uppercase text-muted-foreground">Specially Just For You</span>
        </Link>
    ...
    <footer className="bg-ivory border-t border-border pt-20 pb-8">
      <div className="container-evermaze grid md:grid-cols-[1.3fr_1fr_1fr_1fr] gap-12">
        <div>
          ...
          <p className="mt-2 text-[0.65rem] tracking-[0.4em] uppercase text-muted-foreground">Specially Just For You</p>
